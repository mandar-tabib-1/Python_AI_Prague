...
def save_csv_reconstructed_all(grid2,variable,wind_dir,wind_speed,fn,vectorU):
    print(type(grid2.points))
    if isinstance(grid2.points, np.ndarray):
      points_array = grid2.points
      print(type(points_array))
    else:       
      points_array = vtk_to_numpy(grid2.points.GetData()) #(points.GetData())
      print("vtktonumpy",type(points_array))
   
    #points_array = grid2.points
    print(points_array[:, 2])
    # Convert vtkPoints to numpy array
    #points_array = numpy_support.vtk_to_numpy(grid2.points.GetData())
...
def demo(random_coordinates,date_and_hrs_only,fn2,threshold_absolute_windspeed_mps,threshold_absolute_turbulence_m2ps2,API_KEY = 'fa3e3882b6508618a835169fb753d745',visualization=False,absolute_thres=True): 
...
# Ask for user inputs
    ...
    if absolute_thres==False:
        print("CHECKING FOR locations in Prague with high TURBULENCE and high WIND using a relative threhold of 0.95 times normalized values.")
        threshold=0.95   
        locations_at_high_wind_magnitude=merged_dataframe_U_k_Relative_2_vertiport_reconstructed[merged_dataframe_U_k_Relative_2_vertiport_reconstructed['Normalized_Velocity']>threshold]
        locations_at_high_turbulence=merged_dataframe_U_k_Relative_2_vertiport_reconstructed[merged_dataframe_U_k_Relative_2_vertiport_reconstructed['Normalized_turbulence']>threshold]
        ...
        print("CHECKING FOR locations with high TURBULENCE and high WIND using a USER PROVIDED ABSOLUTE threhold")     
        print(" ")
        print("User_threshold_absolute_turbulence_m2ps2: ", threshold_absolute_turbulence_m2ps2,"m2ps2." )
        print(" ")
        print("User_threshold_absolute_windspeed_mps: ",threshold_absolute_windspeed_mps, "mps.")   
        print(" ") 
        locations_at_high_turbulence=merged_dataframe_U_k_Relative_2_vertiport_reconstructed[merged_dataframe_U_k_Relative_2_vertiport_reconstructed['tke']>threshold_absolute_turbulence_m2ps2]
        locations_at_high_wind_magnitude=merged_dataframe_U_k_Relative_2_vertiport_reconstructed[merged_dataframe_U_k_Relative_2_vertiport_reconstructed['Velocity_mag']>threshold_absolute_windspeed_mps]
        #print("High_turbulence locations obtained FOR USER PROVIDED ABSOLUTE threhold....")
        #print(" ")
        #print(locations_at_high_turbulence)
        #print("For more information: See contents of the variable: locations_at_high_turbulence ")
        #print(" ")
        #print("High_WIND locations obtained OR USER PROVIDED ABSOLUTE threhold.")
        #print(" ")
        #print(locations_at_high_wind_magnitude)
        #print("or more information: See contents of the variable: locations_at_high_wind_magnitude ")
        #print(" ")
